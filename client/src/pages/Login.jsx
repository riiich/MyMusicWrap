...
export const Login = () => {
	return (
		<div className="mx-auto flex min-h-[70vh] w-full max-w-3xl flex-col items-center justify-center px-4 text-center">
			<div className="w-full rounded-[2rem] border border-emerald-200/10 bg-[linear-gradient(145deg,rgba(17,33,23,0.92),rgba(26,52,36,0.88))] px-8 py-12 shadow-[0_26px_60px_rgba(0,0,0,0.26)]">
				<p className="mb-3 text-xs font-bold uppercase tracking-[0.24em] text-emerald-300">Connect Spotify</p>
				<h1 className="mb-4 font-['Gotham_Display'] text-3xl text-[#f5fff7] sm:text-4xl">
					Authorize your Spotify account
				</h1>
				<p className="mx-auto mb-8 max-w-xl text-sm leading-7 text-emerald-50/70 sm:text-base">
