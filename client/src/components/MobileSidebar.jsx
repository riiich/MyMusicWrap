...
export const MobileSidebar = ({
	...
	return (
		<motion.aside
			...
			className="fixed left-0 top-16 z-50 flex h-[calc(100svh-4rem)] max-h-[calc(100svh-4rem)] w-3/4 max-w-sm touch-pan-y flex-col justify-between overflow-hidden overscroll-none border-r border-emerald-700/10 bg-gradient-to-b from-[#f8fff8] via-[#eef8ef] to-[#dff4e3] px-5 pb-5 pt-5 text-[#102016] shadow-2xl shadow-emerald-950/20 sm:hidden dark:border-emerald-100/10 dark:from-[#16351f] dark:via-[#122b19] dark:to-[#0f1711] dark:text-[#eef6ef]"
		>
