		...
		>
			<div className="shrink-0">
				<button
					...
					className="mt-2 inline-flex h-10 w-10 items-center justify-center rounded-full border border-emerald-700/15 bg-white/80 
							 text-[#102016] transition hover:bg-emerald-50 dark:border-emerald-100/15 dark:bg-[#21452a] dark:text-[#eef6ef] 
							 dark:hover:bg-[#295634]"
				>
					{themeIcon}
				</button>
			</div>
